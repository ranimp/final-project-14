...
export default function EDpsikolog() {
...
{admin && <div>
    ...
    <div className="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
        ...
        <form action="/" method="post">
            ...
            <div className="flex flex-col mb-4">
                <label className="text-left mb-2 font-bold text-lg text-black" for="last_name">Spesialis</label>
            ...
            <div class="flex flex-col mb-4">
                        <label className="text-left mb-2 font-bold text-lg text-black">Testimoni</label>

                        <textarea rows="5" name="message" id="message" class="w-full px-3 py-2 border text-grey-800" required></textarea>
            </div>
            <div className="flex flex-col mb-4">
                <label className="text-left mb-2 font-bold text-lg text-black" for="email">Gambar</label>
